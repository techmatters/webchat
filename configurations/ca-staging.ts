...
const translations: Translations = {
  'en-CA': {
    ...
    PreEngagementConfigFormDescription: `Welcome to Kids Help Phone. To help us serve you better, please answer the following questions.`,
    PreEngagementConfigFormNickname: 'Nickname (please do not share your real name)',
    PreEngagementConfigFormHelpline: 'nickname',
    PreEngagementConfigFormSelectHowOldAreYou: 'How old are you?',
    PreEngagementConfigFormFakeHelpline: 'Fake Helpline',
    PreEngagementConfigFormGuest: 'Guest',
    PreEngagementConfigFormAge: 'age',
    PreEngagementConfigForm5OrYounger: '5 or younger',
    PreEngagementConfigFormPreferNotToAnswer: 'Prefer not to answer',
    // PreEngagementConfigForm
  },
  'fr-CA': {
...
const preEngagementConfig: PreEngagementConfig = {
  ...
  fields: [
    {
      type: 'InputItem',
      label: 'PreEngagementConfigFormNickname',
      attributes: {
        name: 'PreEngagementConfigFormHelpline',
        type: 'text',
        placeholder: 'PreEngagementConfigFormGuest',
        required: true,
      },
    },
    {
      label: 'PreEngagementConfigFormSelectHowOldAreYou',
      type: 'SelectItem',
      attributes: {
        name: 'PreEngagementConfigFormAge',
        required: true,
        readOnly: false,
      },
      options: [
        {
          value: '5 or younger',
          label: 'PreEngagementConfigForm5OrYounger',
          selected: true,
        },
        {
          value: '06',
        ...
        {
          value: 'Unknown',
          label: 'PreEngagementConfigFormPreferNotToAnswer',
          selected: false,
        },
      ],
    },
