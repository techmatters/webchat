...
function checkCONFIG(config) {
  const presets = ['dev', 'test-staging', 'beta', 'zm-staging', 'zm-prod', 'za-staging', 'za-prod', 'et-staging', 'mw-staging', 'et-prod', 'mw-prod', 'jm-staging', 'jm-prod', 'ca-staging' , 'uk-staging', 'e2e-dev', 'co-staging'];
